        ...
        <div className='relative'>
            <div className={`pic w-full flex flex-col items-center lg:pt-10 lg:pb-[14rem] relative rounded-[1.25rem] overflow-hidden`}>
                ...
                <div className={`text-white flex gap-[3.625rem] items-center w-full py-[9.7rem] px-[1.88rem] lg:pt-[15rem] lg:px-10
                    ...
                    <div className={`w-full flex flex-col gap-10 xl:w-[73%] md:gap-[3.75rem] xl:pl-[1.88rem] 2xl:min-w-328 lg:max-w-[80rem]
                        ...
                        <div className={`flex flex-col gap-5 ${raleway.className} `}>
                            ...
                            <p className='uppercase text-[2.14rem] leading-[120%] lg:text-[3rem] lg:leading-[3.52rem] font-bold'>Тольяттинский <br /> социально-педагогический <br /> колледж</p>
                        </div>
                ...
                <div className='w-full absolute bottom-0'>
                    <div className={`${raleway.className} relative overflow-hidden w-full h-[80px]`}>
                        <div className="flex absolute bottom-0 left-0 py-5">
                            <div className={`${styles.marqueeContainer} flex items-center gap-2.5`}>
                                {[...Array(12)].map((_, i) => (
                                    <div key={i} className="flex items-center shrink-0">
                                        ...
                                        <p className="uppercase text-white text-[1.5rem] ml-2.5 leading-[100%]">
                                            Думай иначе, будь первым
                                        </p>
                                    </div>
                                ))}
                            </div>
