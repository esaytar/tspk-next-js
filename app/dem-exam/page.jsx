    ...
    return (
        <div className="flex flex-col gap-[1.43rem] px-[2.14rem] w-full mt-[10.3rem]
            ...
            <div className="flex flex-col gap-5">
                <h1 className="text-[1.81rem] font-semibold leading-[33.98px]">Демонcтрационный экзамен</h1>
                <p className="leading-[23.44px] text-[1.25rem]">Это форма аттестации по образовательным программам среднего профессионального образования, которая проводится преимущественно в форме практических заданий в условиях реальных или смоделированных производственных процессов, направленная на определение уровня освоения экзаменуемым образовательной программы и степени сформированности профессиональных знаний, умений и навыков.</p>
            </div>
